...
def two_scales(df, ax1, var, var_lab, y_lab1, y_lab2, order):
    ...
    ax2 = ax1.twinx()
    g = sns.barplot(data=df, x='Grupos', y=var, edgecolor='black', hue=var_lab, palette=['cornflowerblue', 'indianred', 'limegreen'],
                    ax=ax1)
    ...
    sns.pointplot(data=df, x='Grupos', y='Temp', hue='Temp_lab', marker='o', sort=False, ax=ax2,
                      palette=['blue', 'red', 'green'], marksize=2,scale=1.3)
